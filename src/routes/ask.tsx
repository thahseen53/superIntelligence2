          ...
          <CardContent className="flex-1 flex flex-col p-0">
            <div className="flex items-center justify-between px-5 py-3 border-b">
              ...
              <div className="flex gap-2">
                ...
                <Badge variant="secondary" className="gap-1"><Database className="h-3 w-3" />Salesforce</Badge>
                <Badge variant="secondary" className="gap-1"><Database className="h-3 w-3" />ServiceMax</Badge>
                <Badge variant="outline" className="gap-1"><Clock className="h-3 w-3" />Last 30 days</Badge>
              </div>
            </div>
                  ...
                  >
                    ...
                    {m.role === "assistant" && i > 0 && (
                      <div className="mt-3 flex flex-wrap gap-2">
                        {["Annual report.pdf", "Press release", "Salesforce opps", "ServiceMax IB"].map((s, j) => (
                          <Badge key={s} variant="outline" className="gap-1 text-[10px] font-normal">
                            {j < 2 ? <Globe className="h-3 w-3" /> : <Database className="h-3 w-3" />}
                            {s}
